...
module.exports = {};
module.exports = function (id, position, size, color, name) {
  this.id = id;
...
module.exports.prototype.getNameSize = function () {
  return Math.max(~~(.3 * this.size), 25);
};

module.exports.prototype.updatePos = function () {
...
module.exports.prototype.shouldRender = function () {
  if (this.id == 0) {
    return true;
  } else {
...
module.exports.prototype.draw = function (context) {
  // TODO:
};
